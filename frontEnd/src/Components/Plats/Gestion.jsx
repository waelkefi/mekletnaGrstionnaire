...
function Gestion({ selectedDate, PlanPlats }) {
        ...
        <>
            {loading ? (
                ...
                <div className="gestionContainer">
                    {modalOpenAddPlat && <AddPlatModal isOpen={modalOpenAddPlat} onClose={closeModalAddPlat} />}
                    <Snackbar
                        ...
                        Le plat est déjà planifié pour cette date!
                        </Alert>
                    </Snackbar>
                    <div className="gestionContainerHeader">
                        <div>
                            <h3>Plats</h3>
                            <button onClick={() => openModalAddPlat()}>
                    ...
                    <div className="gestionContainerBody">
                        {filteredPlats.map(plat => (
                            <div key={plat._id}>
                                <button onClick={() => addPlatToPlan(plat._id)}>
